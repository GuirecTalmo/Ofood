...
export default function Cgu() {
  return (
    <div className="container">
      <h1 className="cgu cgu__bold">Conditions générales d'utilisation</h1>
      <h2 className="cgu__title">
        <span className="cgu__subtitle">Article 1</span> :{" "}
        <span className="cgu__bold">Objet</span>{" "}
      </h2>
      <p className="cgu__text">
        ...
        l’Utilisateur, l’accès au site doit être précédé de l’acceptation de ces
        CGU. L’accès à cette plateforme signifie l’acceptation des présentes
        CGU.
      </p>
      <h2 className="cgu__title">
        <span className="cgu__subtitle">Article 2</span> :{" "}
        <span className="cgu__bold">Accès au site</span>
      </h2>
      <p className="cgu__text">
        Le site O'Food permet d’accéder gratuitement aux services suivants :
      </p>
      <ol className="cgu__text">
      ...
      <p className="cgu__text">
        ...
        utilisateur disposant d’un accès à Internet. Tous les frais nécessaires
        pour l’accès aux services (matériel informatique, connexion Internet…)
        sont à la charge de l’utilisateur.L’accès aux services dédiés aux
        membres s’effectue à l’aide d’un identifiant et d’un mot de passe.Pour
        des raisons de maintenance ou autres, l’accès au site peut être
        interrompu ou suspendu par l’éditeur sans préavis ni justification.
      </p>
      <h2 className="cgu__title">
        <span className="cgu__subtitle">Article 3</span> :{" "}
        <span className="cgu__bold">Collecte des données</span>
      </h2>
      <p className="cgu__text">
      ...
      <h2 className="cgu__title">
        <span className="cgu__subtitle">Article 4</span> :{" "}
        <span className="cgu__bold">Propriété intellectuelle</span>
      </h2>
      <p className="cgu__text">
        Les marques, logos ainsi que les contenus du site O'Food (illustrations
        ...
        contenus par l’Utilisateur requièrent une autorisation préalable du
        site. Dans ce cas, toute utilisation à des usages commerciaux ou à des
        fins publicitaires est proscrite.
      </p>
      <h2 className="cgu__title">
        <span className="cgu__subtitle">Article 5</span> :{" "}
        <span className="cgu__bold">Responsabilité</span>
      </h2>
      <p className="cgu__text">
        Bien que les informations publiées sur le site soient réputées fiables,
        le site se réserve la faculté d’une non-garantie de la fiabilité des
        sources.Les informations diffusées sur le site O'Food sont présentées à
        ...
        plateforme.Le site décline toute responsabilité concernant les éventuels
        virus pouvant infecter le matériel informatique de l’Utilisateur après
        ...
        confidentialité des données n’est pas assurée par le site. Cependant, le
        site s’engage à mettre en œuvre toutes les méthodes requises pour le
        faire au mieux.
      </p>
    </div>
  );
